...
用户中途直接贴了一份 Greasyfork 上别人写的脚本。那份脚本里已经有正确答案：用 API 而不是 DOM、CSRF Token 从 Cookie 取、429/412 错误处理。但我当时沉迷修自己的 agent-browser 方案，没认真读。

**教训**：如果用户说「别人是这么做的」，先停下来读完。大概率答案已经在了。
